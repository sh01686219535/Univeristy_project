                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <a href="{{ route('advertisement.create') }}" class="btn btn-primary">Create</a>
                                        </div>
                                        <div class="col-md-8">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($advertisement as $data)
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                    <a href="{{ route('advertisement.edit', $data->id) }}"
                                                        class="btn btn-info me-2">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>
                                                    <form action="{{ route('advertisement.destroy', $data->id) }}" method="POST"
